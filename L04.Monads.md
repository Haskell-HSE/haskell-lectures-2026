...
We're going to get much more intimate with it in the following lectures on
capabilities of GHC runtime system, but let's visit other monads first.
...
instance Monad (State s) where
  ...
  State mx >>= clb = State \s0 ->
    let (x, s1) = mx s0
        (y, s2) = runState (clb x) s1
     in (y, s2)
...
![They're the same picture](https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ8ldP--gu9ZZm428oemYlflJtE-2JEwCPL3g&s)
